...
import { AgentRuntime, ChannelType, EventType, createMessageMemory, stringToUuid, type Character, type Content, type Memory, type UUID } from '@elizaos/core';
...
async function main(): Promise<void> {
    ...
    if (!openaiKey) {
        console.error('OPENAI_API_KEY is not set; set it in your environment to use @elizaos/plugin-openai.');
        process.exit(1);
    }

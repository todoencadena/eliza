#!/usr/bin/env bun
/**
 * Build script for @elizaos/plugin-dummy-services using Bun.build
 */
...
async function build() {
  ...
  console.log('🚀 Building @elizaos/plugin-dummy-services...\n');
  ...
  console.log('\n✅ @elizaos/plugin-dummy-services build complete!');

...
`;
    ...
    // This is important for cases where conditional exports don't match or are bypassed
...
`;
    ...
    // Also ensure index.d.ts exists as a fallback for TypeScript
    const mainIndexDts = `// Type definitions for @elizaos/core (fallback)
// Re-exports all types from the Node.js build
export * from './index.node';
`;
    await fs.writeFile('dist/index.d.ts', mainIndexDts);

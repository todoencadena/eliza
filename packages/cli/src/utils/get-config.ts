...
export async function storeOpenAIKey(key: string, envFilePath: string): Promise<void> {
  ...
  try {
    ...
    logger.error('Error saving OpenAI API key:', error instanceof Error ? error.message : String(error));
    throw error;
  }
}
...
export async function storeGoogleKey(key: string, envFilePath: string): Promise<void> {
  ...
  try {
    ...
    logger.error('Error saving Google API key:', error instanceof Error ? error.message : String(error));
    throw error;
  }
}
...
export async function storeAnthropicKey(key: string, envFilePath: string): Promise<void> {
  ...
  try {
    ...
    logger.error('Error saving Anthropic API key:', error instanceof Error ? error.message : String(error));
    throw error;
  }
}
...
export async function storeOllamaConfig(
  ...
  try {
    ...
    logger.error('Error saving Ollama configuration:', error instanceof Error ? error.message : String(error));
    throw error;
  }
}
  ...
  const config: ProviderPromptConfig = {
    ...
    storeFunction: async (results, envPath) => {
      ...
      try {
        ...
        logger.error('Error saving Ollama embedding configuration:', error instanceof Error ? error.message : String(error));
        throw error;
      }
    },
...
export async function storeOpenRouterKey(key: string, envFilePath: string): Promise<void> {
  ...
  try {
    ...
    logger.error('Error saving OpenRouter API key:', error instanceof Error ? error.message : String(error));
    throw error;
  }
}
...
export async function resolveConfigPaths(cwd: string, config: RawConfig) {
  try {
    ...
    logger.error('Failed to resolve config paths:', error instanceof Error ? error.message : String(error));

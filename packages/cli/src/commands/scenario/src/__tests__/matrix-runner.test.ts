...
describe('Matrix Runner', () => {
        ...
        it('should generate all possible parameter combinations', () => {
            ...
            expectedCombinations.forEach(expected => {
                const found = combinations.find(c =>
                    JSON.stringify(c.parameters) === JSON.stringify(expected)
                );
    ...
    describe('calculateExecutionStats', () => {
        it('should calculate correct statistics for basic matrix', () => {
            ...
            expect(stats.estimatedDuration.pessimistic).toBeGreaterThan(stats.estimatedDuration.realistic);
        });
        ...
        it('should scale estimates with number of runs', () => {
            ...
            expect(stats2.estimatedDuration.realistic).toBeGreaterThan(stats1.estimatedDuration.realistic);

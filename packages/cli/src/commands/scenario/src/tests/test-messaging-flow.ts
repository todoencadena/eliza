...
async function testMessagingFlow() {
    ...
    try {
        ...
        // Step 4: Create a channel with proper serverId
        console.log('\n💬 Creating test channel...');
        const channel = await client.messaging.createChannel({
        ...
        console.log('\n🎉 Messaging flow test completed successfully!');
...
// Run the test
testMessagingFlow().catch(console.error); 
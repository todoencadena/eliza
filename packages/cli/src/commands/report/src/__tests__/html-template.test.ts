...
describe('HTML Report Template', () => {
    ...
    describe('File Structure and Validation', () => {
        ...
        it('should have embedded Chart.js library', () => {
            const chartScript = parsedHtml.querySelectorAll('script').find((script: any) =>
                script.innerHTML.includes('Chart') || script.innerHTML.includes('chart')
            );
    ...
    describe('Report Structure and Layout', () => {
        ...
        it('should have results by parameter section', () => {
            const parameterResults = parsedHtml.querySelector('#parameter-results, .parameter-results, #results-by-parameter');
            expect(parameterResults).toBeTruthy();
        });

        it('should have capability analysis section', () => {
            const capabilities = parsedHtml.querySelector('#capability-analysis, .capability-analysis, #capabilities');
            expect(capabilities).toBeTruthy();
        });

        it('should have trajectory analysis section', () => {
            const trajectories = parsedHtml.querySelector('#trajectory-analysis, .trajectory-analysis, #trajectories');
    ...
    describe('Component Placeholders', () => {
        ...
        it('should have placeholder for overall success rate', () => {
            const successRate = parsedHtml.querySelector('#summary-success-rate, #success-rate, #overall-success-rate');
            expect(successRate).toBeTruthy();
        });

        it('should have placeholder for average execution time', () => {
            const avgTime = parsedHtml.querySelector('#summary-avg-time, #average-execution-time, #avg-execution-time');
        ...
        it('should have data island for JSON data', () => {
            const dataIsland = parsedHtml.querySelector('script[id="report-data"][type="application/json"]');
    ...
    describe('JavaScript Integration', () => {
        it('should have renderReport function defined', () => {
            const renderScript = parsedHtml.querySelectorAll('script').find((script: any) =>
                script.innerHTML.includes('renderReport')
            );
        ...
        it('should have function to handle data injection', () => {
            ...
            const hasDataHandling = scripts.some((script: any) =>
                script.innerHTML.includes('getElementById') ||
                script.innerHTML.includes('querySelector')
            );

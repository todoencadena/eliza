#!/usr/bin/env bun
/**
 * Build script for @elizaos/plugin-quick-starter using Bun.build
 */
...
async function build() {
  ...
  console.log('🚀 Building @elizaos/plugin-quick-starter...\n');
  ...
  console.log('\n✅ @elizaos/plugin-quick-starter build complete!');

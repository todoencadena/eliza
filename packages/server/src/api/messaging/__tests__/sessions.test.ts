...
describe('Sessions API', () => {
    ...
    describe('GET /api/messaging/sessions/:sessionId', () => {
        ...
        it('should return 404 for non-existent session', async () => {
            const response = await request(app)
                .get(`/api/messaging/sessions/${uuidv4()}`);
    ...
    describe('GET /api/messaging/sessions/:sessionId/messages', () => {
        ...
        it('should handle limit parameter', async () => {
            const response = await request(app)
                .get(`/api/messaging/sessions/${sessionId}/messages?limit=1`);
        ...
        it('should reject invalid limit', async () => {
            const response = await request(app)
                .get(`/api/messaging/sessions/${sessionId}/messages?limit=invalid`);
        ...
        it('should handle after parameter correctly', async () => {
            ...
            const response = await request(app)
                .get(`/api/messaging/sessions/${sessionId}/messages?after=${afterTimestamp}`);
        ...
        it('should handle before parameter', async () => {
            ...
            const response = await request(app)
                .get(`/api/messaging/sessions/${sessionId}/messages?before=${beforeTimestamp}`);
    ...
    describe('DELETE /api/messaging/sessions/:sessionId', () => {
        ...
        it('should return 404 for non-existent session', async () => {
            const response = await request(app)
                .delete(`/api/messaging/sessions/${uuidv4()}`);
